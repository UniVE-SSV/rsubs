...
public interface MuJsVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code RandomBool}
	 * labeled alternative in {@link MuJsParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRandomBool(MuJsParser.RandomBoolContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code RandomStr}
	 * labeled alternative in {@link MuJsParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRandomStr(MuJsParser.RandomStrContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitNotEquals(MuJsParser.NotEqualsContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitContains(MuJsParser.ContainsContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAssert(MuJsParser.AssertContext ctx);
	/**
